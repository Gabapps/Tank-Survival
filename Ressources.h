...
typedef enum {MESH_TANK, MESH_TANK_DAMAGED, MESH_TANK_DEAD, MESH_WALL, MESH_ANTICHAR, MESH_MISSILE, MESH_GROUND, MESH_EXPLOSION, MESH_ITEMS_SPEED_M, MESH_ITEMS_SPEED_L, MESH_ITEMS_FIRE_M, MESH_ITEMS_FIRE_L, MESH_ITEMS_LASER_M, MESH_ITEMS_LASER} Mesh_ID;

typedef enum {SHADER_GUI, SHADER_TEXTURE, SHADER_NOTEXTURE} Shader_ID;

typedef enum {TEXTURE_TANK, TEXTURE_TANK_DAMAGED, TEXTURE_TANK_DEAD, TEXTURE_WALL, TEXTURE_ANTICHAR, TEXTURE_BULLET, TEXTURE_GROUND, TEXTURE_EXPLOSION, TEXTURE_GREEN, TEXTURE_RED} Texture_ID;
