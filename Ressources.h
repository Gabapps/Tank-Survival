...
typedef enum {MESH_TANK, MESH_TANK_DAMAGED, MESH_TANK_DEAD, MESH_WALL, MESH_ANTICHAR, MESH_MISSILE, MESH_GROUND, MESH_EXPLOSION} Mesh_ID;
typedef enum {SHADER_GUI, SHADER_TEXTURE, SHADER_NOTEXTURE} Shader_ID;
typedef enum {TEXTURE_TANK, TEXTURE_TANK_DAMAGED, TEXTURE_TANK_DEAD, TEXTURE_WALL, TEXTURE_ANTICHAR, TEXTURE_BULLET, TEXTURE_GROUND, TEXTURE_EXPLOSION} Texture_ID;
