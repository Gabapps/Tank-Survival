...
typedef enum {MESH_TANK, MESH_TANK_DAMAGED, MESH_TANK_DEAD, MESH_WALL, MESH_MISSILE, MESH_GROUND} Mesh_ID;
typedef enum {SHADER_GUI, SHADER_TEXTURE, SHADER_NOTEXTURE} Shader_ID;
typedef enum {TEXTURE_TANK, TEXTURE_TANK_DEAD, TEXTURE_WALL, TEXTURE_BULLET, TEXTURE_GROUND} Texture_ID;
